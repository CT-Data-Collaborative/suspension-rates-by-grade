Suspension Rate by Grade Range

[![Build Status](https://travis-ci.org/CT-Data-Collaborative/suspension-rate-by-grade-range.svg?branch=master)](https://travis-ci.org/CT-Data-Collaborative/suspension-rate-by-grade-range)
